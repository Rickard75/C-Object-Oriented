...
void QuadraticFitter::update() const {
  double discr = ( sumx0y0 * sumx2y0 * sumx4y0 ) +
                 ( sumx1y0 * sumx3y0 * sumx2y0 ) +
                 ( sumx2y0 * sumx1y0 * sumx3y0 ) -
                 ( sumx0y0 * sumx3y0 * sumx3y0 ) -
                 ( sumx1y0 * sumx1y0 * sumx4y0 ) -
                 ( sumx2y0 * sumx2y0 * sumx2y0 );
  double ca0 = ( ( sumx2y0 * sumx4y0 ) - ( sumx3y0 * sumx3y0 ) ) / discr;
  double ca1 = ( ( sumx3y0 * sumx2y0 ) - ( sumx1y0 * sumx4y0 ) ) / discr;
  double ca2 = ( ( sumx1y0 * sumx3y0 ) - ( sumx2y0 * sumx2y0 ) ) / discr;
  double cb0 = ( ( sumx2y0 * sumx3y0 ) - ( sumx1y0 * sumx4y0 ) ) / discr;
  double cb1 = ( ( sumx0y0 * sumx4y0 ) - ( sumx2y0 * sumx2y0 ) ) / discr;
  double cb2 = ( ( sumx1y0 * sumx2y0 ) - ( sumx0y0 * sumx3y0 ) ) / discr;
  double cc0 = ( ( sumx1y0 * sumx3y0 ) - ( sumx2y0 * sumx2y0 ) ) / discr;
  double cc1 = ( ( sumx2y0 * sumx1y0 ) - ( sumx0y0 * sumx3y0 ) ) / discr;
  double cc2 = ( ( sumx0y0 * sumx2y0 ) - ( sumx1y0 * sumx1y0 ) ) / discr;
